...
ps.wimp.object <- wimp_raw_to_phyloseq(path.to.wimp.files = "../data/example_amr_data/",
                                     metadata = epi2me.metadata,
...
mgs.wimp.object <- wimp_raw_to_metagenomeseq(path.to.wimp.files = "../data/example_amr_data/",
                                     metadata = epi2me.metadata,
                                     keep.unclassifed = FALSE, 
                                     keep.human = FALSE)
mgs.wimp.object
