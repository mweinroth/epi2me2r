...
- `coveragenumber` *optional* : the total length of the gene that must be present for it to be included in the count table, the default is 80%; this argument takes any number from 1 to 99. 
...
```{r amr, eval = FALSE}
ps.amr.object <- amr_raw_to_phyloseq(path.to.files = "~/User/Documents/my_amr_files", 
