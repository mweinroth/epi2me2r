...
epi2me.metadata <- read.csv("../inst/example_metadata.csv")
...
```{r amr phylo}
ps.amr.object <- amr_raw_to_phyloseq(path.to.amr.files = "../inst/example_amr_data/",
...
```{r amr mgs}
mgs.amr.object <- amr_raw_to_metagenomeseq(path.to.amr.files = "../inst/example_amr_data/",
                                     metadata = epi2me.metadata,
                                     coveragenumber = 80, 
                                     keepSNP = FALSE)
mgs.amr.object
...
ps.wimp.object <- wimp_raw_to_phyloseq(path.to.wimp.files = "../inst/example_wimp_data/",
                                     metadata = epi2me.metadata,
...
mgs.wimp.object <- wimp_raw_to_metagenomeseq(path.to.wimp.files = "../inst/example_wimp_data/",
                                     metadata = epi2me.metadata,
                                     keep.unclassifed = FALSE, 
                                     keep.human = FALSE)
mgs.wimp.object
...
```{r amr read in}
amr.count.table <- read_in_amr_files(path.to.amr.files = "../inst/example_amr_data/",
                                     coveragenumber = 80, 
                                     keepSNP = FALSE)
...
```{r wimp read in}
wimp.count.table <- read_in_wimp_files(path.to.wimp.files = "../inst/example_wimp_data/")
